...
public class TSorteoSimulator extends Thread {
	...
	public TSorteoSimulator(String nombre, int bolaInicial, int bolaFinal, int cantidadBolas) {
		this.nombre = nombre;
	...
	public void generaUnaCombinaciónGanadora(long milis) {
		try {
			...
			System.out.println("BONOLOTO ITALIANA");
			System.out.println("");
			...
			for (Integer integer : numeroSeleccionados) {
				Thread.sleep(milis);
				System.out.println("-bonoloto italiana: " + integer);
			}
			System.out.println("");
